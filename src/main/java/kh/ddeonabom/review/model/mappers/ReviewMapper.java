...
public interface ReviewMapper {
	...
	ArrayList<Review> selectReviewList(@Param("pi") PageInfo pi, @Param("keyword") String keyword, @Param("region") String region,  @Param("loginUserNo")Integer loginUserNo, @Param("sort")String sort);
