...
public class LandmarkService {
	...
	public ArrayList<Landmark> searchLandmarks(String q, int page, int size) {
	    int offset = page * size;
	    return mapper.searchLandmarks(q, offset, size);
	}

	public int countLandmarks(String q) {
	    return mapper.countLandmarks(q);
	}
